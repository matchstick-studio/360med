...
from network.forum.search import preform_search
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=1,
            help="Verbosity level of the report.",
        )
    ...
    def handle(self, *args, **options):
        ...
        if uid:
            ...
            finish, results = time_func(
                preform_search,
                kwargs=dict(query=uid, fields=["uid"], more_like_this=True),
            )
