...
from network.forum import sync
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="",
            help="Remote host name housing the postgres database.",
        )
        parser.add_argument(
            "--dbname", type=str, default="", help="Remote postgres database name."
        )
        parser.add_argument(
            "--port", type=str, default="5432", help="Postgres port on remote host."
        )
        parser.add_argument("--user", type=str, default="www", help="Postgres user.")
        parser.add_argument(
            "--password", type=str, default="", help="Postgres password."
        )
        parser.add_argument(
            "--batch",
            type=int,
            default=10,
            help="How many posts to load for the given date range.",
        )
        parser.add_argument(
            "--start",
            type=str,
