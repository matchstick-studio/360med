...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="Reports on the content of the index.",
        )
        parser.add_argument(
            "--index", type=int, default=0, help="How many posts to index"
        )
    ...
    def handle(self, *args, **options):
        ...
        if index:
            ...
            start_count = (
                Post.objects.valid_posts(indexed=False).exclude(root=None).count()
            )
