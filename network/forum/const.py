...
MYVOTES, MYPOSTS, MYTAGS, OPEN, FOLLOWING, SHOW_SPAM = [
    "myvotes",
    "myposts",
    "mytags",
    "open",
...
JOBS, TOOLS, TUTORIALS, FORUM, PLANET = [
    "jobs",
    "tools",
    "tutorials",
    "forum",
...
PRIVATE_TOPICS = [MYPOSTS, MYTAGS, MESSAGE, MENTIONED, BOOKMARKS, FOLLOWING, MYVOTES]
