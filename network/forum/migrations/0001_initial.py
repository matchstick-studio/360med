        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.IntegerField(
                        choices=[(0, "Bronze"), (1, "Silver"), (2, "Gold")], default=0
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "spam",
                    models.IntegerField(
                        choices=[(0, "Spam"), (1, "Not spam"), (2, "Default")],
                        default=2,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="thread_users", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (0, "local messages"),
                            (1, "email"),
                            (4, "email for every new thread (mailing list mode)"),
                        ],
                        default=0,
                    ),
                ),
